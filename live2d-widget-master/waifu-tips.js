...
function loadWidget(config) {
	...
	let userAction = false,
		userActionTimer,
		messageTimer,
		messageArray = ["咳咳，有些人，你看你成绩像啥子哦", "鸢飞戾天，鱼跃于渊，我辈志翔，必创辉煌！！", "2023年6月7日，乾坤未定，你我皆是黑马！！", "毕业后你有什么梦想呢", "高考完后， 不论好坏，我都带你去吃一顿...","有什么想说的，对我说吧，等留言区出来了写在那里也行！","这个网站没什么特别的，但如果你喜欢的话，刚刚也不应该执着地想踩我的......"];
	...
	(function registerEventListener() {
		...
		document.querySelector("#waifu-tool .fa-camera-retro").addEventListener("click", () => {
			showMessage("照好了吗，是不是很可爱呢？", 6000, 9);
		...
		document.querySelector("#waifu-tool .fa-times").addEventListener("click", () => {
			...
			showMessage("愿你有一天能与重要的人重逢。", 2023, 6);
		...
		window.addEventListener("visibilitychange", () => {
			if (!document.hidden) showMessage("你终于回来了～", 6000, 10);
		});
	})();
